================================================================================
    MICROSOFT 基础类库： TotalMatch 项目概述
===============================================================================

应用程序向导已为您创建了此 TotalMatch 应用程序。此应用程序
不仅介绍了使用 Microsoft 基础类的基本知识，
而且是编写应用程序的起点。

此文件包含组成 TotalMatch 应用程序的每个文件的内容摘要。
...
TotalMatch.h
    ...
    CTotalMatchApp 应用程序类。

TotalMatch.cpp
    这是包含应用程序
    类 CTotalMatchApp 的主应用程序源文件。
...
应用程序向导将创建一个对话框类：
TotalMatchDlg.h、TotalMatchDlg.cpp - 对话框
    这些文件包含 CTotalMatchDlg 类。  此类定义
    应用程序主对话框的行为。  此对话框的模板包含在 
    TotalMatch.rc 中，而此文件可以在 Microsoft Visual C++ 中进行编辑。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 TotalMatch.pch 的预编译头文件 (PCH)
