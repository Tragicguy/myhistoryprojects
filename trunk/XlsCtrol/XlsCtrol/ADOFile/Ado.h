...
public:
	...
	void OpenSchema(CStringArray &strArray);
	// 操作 -----------------------------------------------
public:
	// 数据库连接 --------------------------------
	...
	BOOL ConnectExcel(CString dbpath,long lOptions=adConnectUnspecified);
	BOOL ConnectMysql(CString strServer,CString strDatabase,CString strUID,CString strPwd,CString strCharset,int iPort=3306,long lOptions=adConnectUnspecified);
	BOOL ConnectToOracle(CString strServer,CString strDatabase,CString strUID,CString strPwd,long lOptions=adConnectUnspecified);
