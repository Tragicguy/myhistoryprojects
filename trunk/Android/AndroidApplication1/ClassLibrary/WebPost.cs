...
namespace ClassLibrary
{
    public class ClassHttpPost
    {
        ...
        public string GetHttpPageAsyc(string strUrl, string strEncode, string strType,
            string strCookie, string strData, string strReferer, string strAcceptType,
            string strExtendHead, Action<string> callback)
        {
            try
            {
                Stream stream = GetHttpPageSteam(strUrl, strEncode, strType, strCookie, strData, strReferer, strAcceptType, strExtendHead, callback);
                if (stream == null)
                {
                    return "";
                }
            ...
            string strExtendHead, Action<string> callback)
        {
            try
            {
                ...
                //异步发送请求
                m_Request.BeginGetResponse(new AsyncCallback(asyncResult =>
                {
                    try
                    {
