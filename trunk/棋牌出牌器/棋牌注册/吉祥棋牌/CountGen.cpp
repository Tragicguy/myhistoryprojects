...
CString gl_strAccType = "";
CString gl_strPwdType = "";
int		gl_pwdAppenAcc = 0;
CString gl_strNickNameType = "";
CString gl_strReferrerType = "";
CString gl_strIdentityType = "";
...
BOOL CCountGen::OnInitDialog()
{
	...
	::SetWindowPos(m_hWnd,HWND_TOP,0,0,475,160,SWP_SHOWWINDOW|SWP_NOMOVE);
...
int CCountGen::GenerateCounts()
{
	...
	for (int i=0;i< generateNum;)
	{
		...
		rgPack.strIntroMan = strMail;			//推荐人
		rgPack.strIdentity = strIntroManEx;		//身份证号
		rgPack.strSex.Format("%c",strIntroManEx.GetAt(16));
		rgPack.strName = strNickNameEx+"1";
...
int CCountGen::SaveParams()
{
	...
	gl_strAccType = strAccType;
	gl_strPwdType = strPwdType;
	gl_strNickNameType = strNickName;
	gl_strIdentityType = strIntroMan;
	gl_strReferrerType = strMailType;
