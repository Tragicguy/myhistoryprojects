...
public:
	...
	void AddToAccList(CString strAcc,CString strPwd,CString strContent);
	...
	int GetWindowCtrl();
	void InsertData(CString strTile,CString strContent,CString strUrl);
	int WriteToBase(CString strTile,CString &strContent,CString strUrl);
