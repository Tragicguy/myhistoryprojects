...
namespace DuiLib
{
	...
	void CButtonUI::SetDisabledCursor(LPCTSTR pStr)
	{
		m_sDisabledCursor = pStr;
	}
	//************************************
	// Method:    GetForeImage
	...
	void CButtonUI::SetAttribute(LPCTSTR pstrName, LPCTSTR pstrValue)
	{
		...
		else if( _tcscmp(pstrName, _T("disablecursor")) == 0 )
		{
			SetDisabledCursor(pstrValue);
		}
