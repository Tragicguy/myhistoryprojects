...
#define AESENCRYPTION_CLASS __declspec(dllexport)
#else
#define AESENCRYPTION_CLASS __declspec(dllimport)
#endif

class AESENCRYPTION_CLASS AESencrypt
...
class AESENCRYPTION_CLASS AESdecrypt
