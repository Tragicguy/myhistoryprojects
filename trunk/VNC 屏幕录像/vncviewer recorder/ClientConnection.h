...
#define SETTINGS_KEY_NAME "Software\\ORL\\RTSServer\\Settings"
...
//This section is updated by xpb 2002/02/06, begin:
	...
	char m_sUISectionName[128];
	char m_sInfoSectionName[128];
	char m_sMessTitle[64];
//This section is updated by xpb 2002/02/06, end.
//This section is updated by xpb 2002/02/26, begin:
	//The following original source code is disabled by xpb 2002/02/26.
	//The following is the new source code added by xpb 2002/02/26

	//This is a timer. When the RTS client has not been used for the given seconds, 
	//the execution must stop. The default interval is 5 min.
	UINT m_QuitTimer;
	int m_iQuitTimerInterval;
	bool m_bExitRTSServer;
	int m_iOldMouseX;
	int m_iOldMouseY;
