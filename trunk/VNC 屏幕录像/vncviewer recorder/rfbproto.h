...
typedef struct _rfbFullScreenModeMsg {
    CARD8 type;			/* always rfbFullScreenMode */
} rfbFullScreenModeMsg;
#define sz_rfbFullScreenModeMsg 1
