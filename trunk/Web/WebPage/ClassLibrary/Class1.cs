...
namespace ClassLibrary
{
    ...
    {
        public static CookieContainer m_Cookie;
        public static string GetHttpPage(string strUrl, string strEncode, string strType,
        ...
        public static Stream GetHttpPageSteam(string strUrl, string strEncode, string strGetType,
            string strCookie, string strData, string strReferer, string strAcceptType,
            string strExtendHead)
        {
            try
