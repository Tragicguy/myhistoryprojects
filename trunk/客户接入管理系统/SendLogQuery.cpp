...
BOOL CSendLogQueryApp::InitInstance()
{
	...
	// TODO: 应适当修改该字符串，
	// 例如修改为公司或组织名
	SetRegistryKey(_T("客户接入管理工具"));
	::CoInitialize(NULL);
	
	CString strskinPath;
	strskinPath = GetAppPath() + "\\" + "skins\\bbq.ssk";
	TCHAR szPath[1000] = {0};
	strcpy(szPath,strskinPath);
	skinppLoadSkin(_T(szPath));//加载皮肤
