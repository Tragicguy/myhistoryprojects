...
void CjobpostDlg::SetTableStyle()
{
	...
	conList->InsertColumn(1,"域名",LVCFMT_LEFT,150);
	conList->InsertColumn(2,"邮箱",LVCFMT_LEFT,200);
	conList->InsertColumn(3,"处理状态",LVCFMT_LEFT,150);
	conList->InsertColumn(4,"保险箱金币",LVCFMT_LEFT,0);
	conList->InsertColumn(5,"状态",LVCFMT_LEFT,0);
}
/************************************************************************/
/*                                                                      */
/************************************************************************/
void CjobpostDlg::InitListCtrl()
{
	...
	m_message.MoveWindow(7,346,550,160);
...
int CjobpostDlg::GetPower()
{
	...
	try
	{
		...
		if (pFile != NULL)
		{
			...
			{
				strTemp.MakeLower();
				if (strTemp.Find("myownpowewhoise") !=-1)
				{
					pFile->Close();
					delete pFile;
					pFile = NULL;
