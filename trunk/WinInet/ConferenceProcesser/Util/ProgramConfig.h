...
public:
	...
	~CLocker();
public:
	static CCriticalSection  m_locker;
#ifdef _DEBUG
	long m_index;
	int ii;
#endif
...
public:
	...
	CString ReadStringConfigParameter(LPCTSTR lpAppName, LPCTSTR lpParaName, LPCTSTR lpDefault);
//lpAppName 
...
public:
	...
	char m_CurrentPath[MAX_PATH];  // Current path
...
#endif
private:
	char m_sUISectionName[MAX_PATH];

	char * GetLanguage();

	char m_configFileName[MAX_PATH]; //Attribute to keep the config file name, 
