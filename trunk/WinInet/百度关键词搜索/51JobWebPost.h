...
public:
	...
	int HelpSubject(CString strUserName,CString strPwd,CString strUrl,CString strSubContent,int iDelay,CString &strError);
	CString GetKeyStringEx(CString srcStr,CString &strBefore,CString &strAfter);
	CString RandContent();
	bool IsOverLastTime(unsigned int iErrorStopTime,long lastTime);
	void LogOut();
	CString GetKeyStringExEx(CString srcStr,CString &strBefore,CString &strAfter);
	int GetKeyWords(CString strKey,int iParent,CString &strError);
private:
