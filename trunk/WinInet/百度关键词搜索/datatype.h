...
extern int g_iUtfFlag;
extern int g_iTimeStart;
extern int g_iTimeEnd;
extern int g_iTimeDelay ;
extern int g_iFreshDelay;
extern int g_iHelpDelay;
extern CArray<CString, CString> g_ContentList;
extern void ShowMessage(CString strMsg);
...
extern map<CString,int> g_keyMap;
