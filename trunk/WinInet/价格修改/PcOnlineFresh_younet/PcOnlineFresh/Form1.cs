...
//                     }
        ...
        private void btnImportAcc_Click(object sender, EventArgs e)
        {
            ...
            foreach (string strLine in strArray)
            {
                ...
                {
                    //加载同步信息
                    string strInfoEx = ReadFileLineEx(strSynPath);
                    ...
                    foreach (string strGoodInfo in strArrayEx)
                    {
                        ...
                        goodModify.strNo2 = strSynInfo[3];
                        goodModify.strUrl = strSynInfo[4];
        ...
        private string ReadFileLineEx(string strFilePath)
        {
                   ...
                   {                       
                       ...
                       if (hTableSyn.ContainsKey(strNo))
                       {
                          ...
                          // goodModify.fHighPrice = goodModifySyn.fHighPrice;
                           goodModify.strNo2 = goodModifySyn.strNo2;
                           goodModify.strUrl = goodModifySyn.strUrl;
                           goodModify.fPrice = fPrice;
...
//                            }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
           // _GoodsFreshStr objInfoEx = new _GoodsFreshStr();
            ...
            objFresh.SetWebPost(goodInfo.webPost);
            string strId = "";
            bRet = objFresh.Login(goodInfo.strAcc, goodInfo.strPwd, true, out strId);
            string strError = "";
        ...
        private bool FreshQuick(ref _GoodsFreshStr goodInfo, GoodsFresh objFresh)
        {
            ...
            ShowInfo(goodInfo);
            string strId = "";
            bool bRet = objFresh.Login(goodInfo.strAcc, goodInfo.strPwd, true, out strId);
            if (!bRet)
            {
                strError = "登录失败";
        ...
        private bool Modify(ref _GoodsFreshStr goodInfo, GoodsFresh objFresh)
        {
            ...
            while (m_bFresh && !bBreak)
            {
...
#else
                iRet = objFresh.Fresh(out strError, out iModifyCount, out iGoodCount, out bBreak, iCurPage + 1, true, ref hWaitTable, ref hFailTable, ref iNetErrorCount,strId);
#endif
                ...
                {
                    goodInfo.strModifyStatus = strError + ",正在重试...";
