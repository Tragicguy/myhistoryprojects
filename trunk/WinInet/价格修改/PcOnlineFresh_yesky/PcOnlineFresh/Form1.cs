            ...
            foreach (string strLine in strArray)
            {
                ...
                else
                {
                    ...
                    foreach (string strGoodInfo in strArrayEx)
                    {
                        ...
                        goodModify.dealerPriceId = strSynInfo[5];
                        goodModify.oldstatus = strSynInfo[6];
                        goodModify.refprice = strSynInfo[7];
                        goodModify.strOtherInfo = strSynInfo[8];
                        goodModify.strAdvert = strSynInfo[9];
                        /*
                        ...
                        if (strSynInfo.Length > 11)
                        {
                            for (int i = 9; i < strSynInfo.Length - 2;i++ )
                            {
                                goodModify.strAdvert += strSynInfo[i];
                            }
                        }
                        else{
                            goodModify.strAdvert = strSynInfo[9];
               ...
               foreach (string strLine in strArray)
               {
                   ...
                   {                       
                       ...
                       if (hTableSyn.ContainsKey(strNo))
                       {
                           ...
                           goodModify.dealerPriceId = goodModifySyn.dealerPriceId;
                           goodModify.oldstatus = goodModifySyn.oldstatus;
                           goodModify.strOtherInfo = goodModifySyn.strOtherInfo;
                           goodModify.strAdvert = goodModifySyn.strAdvert;
                           goodModify.refprice = goodModifySyn.refprice;
                           goodModify.fPrice = fPrice;
