...
void CjobpostDlg::SetTableStyle()
{
	...
	conList->InsertColumn(1,"今日已取次数",LVCFMT_LEFT,100);
	conList->InsertColumn(2,"游戏ID号",LVCFMT_LEFT,100);
	conList->InsertColumn(3,"密码",LVCFMT_LEFT,130);
	conList->InsertColumn(4,"最后状态",LVCFMT_LEFT,380);
}
/************************************************************************/
/*                                                                      */
/************************************************************************/
void CjobpostDlg::InitListCtrl()
{
	...
	g_message.InsertColumn(0,_T("时间"),LVCFMT_LEFT,125);
	g_message.InsertColumn(1,_T("信息"),LVCFMT_LEFT,390);
}
/************************************************************************/
/*                                                                      */
/************************************************************************/
