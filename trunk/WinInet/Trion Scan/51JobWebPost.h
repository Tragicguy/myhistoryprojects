...
extern string gl_strMac;
extern int ReportStatus(CString strUser,CString strPwd,CString strMac,int iLast,int iStatus);
extern int Reg(CString strUser,CString strPwd,CString strMac);
class C51JobWebPost
{
public:
	C51JobWebPost();
	...
	int UserLogin(CString strUser,CString strPwd);
private:
