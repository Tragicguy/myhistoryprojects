...
namespace PcOnlineFresh
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void btnStartFresh_Click(object sender, EventArgs e)
        {
            ...
            m_bSuspendFresh = false;
            m_nNeedPreInfo = checkBoxNeedPreInfo.Checked;
            Int32.TryParse(textBoxType.Text, out m_nType);
        ...
        private void btnImportAcc_Click(object sender, EventArgs e)
        {
            ...
            {
                //userid|pwd|username|phone|email|goodtype
                ...
                GoodInfo.strReceiver = strInfo[2];
                GoodInfo.strPhone = strInfo[3];
                GoodInfo.strEmail = strInfo[4];
                GoodInfo.strType = strInfo[5];
...
//                }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string strError = "";
            bool bRet = Login(webpost, "shaojun.hnist@gmail.com", "wawawo20", ref strError, false);
      ...
      //  https://session.trionworlds.com/login;jsessionid=F355EBF3FCC45A052024921548FD6D59
        ...
        public bool GetImage(ClassHttpPost webPost, string strFile, out string strError, string strUrl, string strReffer)
        {
            ...
            try
            {
                Stream stream = webPost.GetHttpPageSteam(strUrl, "gb2312", "get", "", "", strReffer, "*/*", "", null);
                if (stream == null)
                {
