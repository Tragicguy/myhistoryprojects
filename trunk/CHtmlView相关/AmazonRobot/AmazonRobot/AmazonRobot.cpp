...
void InitParams(CString strPath)
{
	...
	gl_AmazonStr.eSendType = (_SendTime)::GetPrivateProfileInt(strNode,"eSendType",1, strPath);
	...
	gl_AmazonStr.bCanNormalSend = ::GetPrivateProfileInt(strNode,"bCanNormalSend",1, strPath);
}
// CAmazonRobotApp 构造
//清除指定网站的COOKIE
