...
void AddToShowList(RegisterPack rgPack)
{
	...
	{
		if (g_AccList.GetItemText(i,1) == rgPack.strAcc&&g_AccList.GetItemText(i,7) != "成功")
		{
...
int C51JobWebPost::AddEmail(RegisterPack &rgPack)
{
	...
	case -3:
		{
			//ShowMessageExEx("填写信息有误");
			rgPack.strMemo = "填写信息有误";
			rgPack.iStatus = 2;
			return -3;
			break;
		}
...
// 	{
// 	case 0:
// 		ShowMessageExEx("手机验证码已经发送,请尽快填写手机验证码");
// 		break;
// 	case -2:
// 		{
// 			ShowMessageExEx("添加过程中出现错误,重新开始");
...
// 		}
// 	}
// 	SendAddMessage(6,g_strCheckCode);//发送手机号
// 	while(true)		//等待窗口返回登录验证信息
// 	{
// 		if (g_ExitFlag)
// 		{
